...
class NewspaperListViewReaders(LoginRequiredMixin, generic.ListView):
    model = Newspaper

    context_object_name = "news_for_readers"
    template_name = "newspaper_agency/news_for_readers.html"
